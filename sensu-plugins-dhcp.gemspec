...
if RUBY_VERSION < '2.0.0'
  require 'sensu-plugins-dhcp'
else
  require_relative 'lib/sensu-plugins-dhcp'
end
...
Gem::Specification.new do |s|
  ...
  s.description            = 'This plugin provides native DHCP instrumentation
                              for monitoring of a DHCP server response to
